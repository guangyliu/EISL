...
def add_optimization_args(parser):
    ...
    # fmt: off
    group.add_argument("--bestbleu_ngram", default=0)
...
def add_model_args(parser):
    ...
    group.add_argument("--tf-ratio", default=1)
    group.add_argument("--sample-method", default="greedy")
    group.add_argument("--top-k", default=5)
    # fmt: on
    return group
