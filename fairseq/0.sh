for i in 0 #7 #8  #20 #10 15 20 25 30 35 40 45 50 # 35 50 # 5 15 30 #  10 20 25 # # 
do
base_noise="rep"
preix=$base_noise
sym="cetf_$i"
...
BART_PATH=./examples/bart/pretrained/bart.base/model.pt
...
CUDA_VISIBLE_DEVICES=$cuda  fairseq-train multi30k-bin/$noise \
    ...
    --tf-ratio $tf_ratio --tensorboard-logdir log/tf/denoising_bart/$preix/$name \
     --max-epoch $max_epoch --no-epoch-checkpoints   --patience 3  #--fp16-scale-tolerance=0.25 #--eval-bleu-print-samples  --log-interval 5
