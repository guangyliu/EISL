...
lr="1e-3"
tf_ratio="0.0"
sym="nat_top20meanrand_1234_rand" #"40_no_rand_2gum_no_de"
preix="autoencoder_iwslt_en"
lr_sch="fixed"
warmup=3000
max_epoch=40
restore_file="checkpoints/autoencoder_iwslt_en/cr_au_ls_greedy_base/checkpoint_best.pt"
...
then 
    ...
    --save-interval 1 --clip-norm 0.1 --max-epoch $max_epoch  --top-k $top_k --warmup-updates $warmup  > log/out/$preix/$name.out 2>&1 &
